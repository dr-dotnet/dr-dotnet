...
public class SegfaultReproTests
{
    ...
    //        Trace.WriteLine($"[{nameof(Attach_Using_DiagnosticsClient_TempDir)}] Iteration {i}");
    ...
    //        Console.WriteLine($"[{nameof(Attach_Using_DiagnosticsClient)}] Profiler path: '{profilerDll}'");
    //        Trace.WriteLine($"[{nameof(Attach_Using_DiagnosticsClient)}] Profiler path: '{profilerDll}'");
