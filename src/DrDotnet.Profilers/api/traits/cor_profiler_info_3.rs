use crate::{
    ffi::{
        mdFieldDef, AppDomainID, ClassID, CorProfilerFunctionEnum, CorProfilerModuleEnum, FunctionEnter3, FunctionEnter3WithInfo, FunctionID,
        ...
        COR_PRF_FRAME_INFO, HRESULT,
    },
    CorProfilerInfo2, FunctionEnter3Info, FunctionLeave3Info, ModuleInfo2, RuntimeInfo, StringLayout,
};
use std::ffi::c_void;
...
pub trait CorProfilerInfo3: CorProfilerInfo2 {
    ...
    fn set_function_id_mapper_2(&self, func: FunctionIDMapper2, client_data: *const c_void) -> Result<(), HRESULT>;
