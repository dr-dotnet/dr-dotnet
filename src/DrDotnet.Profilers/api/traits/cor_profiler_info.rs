use crate::{
    ffi::{
        mdMethodDef, AppDomainID, AssemblyID, ClassID, ContextID, CorOpenFlags, FunctionEnter, FunctionID, FunctionIDMapper, FunctionLeave, FunctionTailcall,
        MethodMalloc, ModuleID, ObjectID, ThreadID, COR_DEBUG_IL_TO_NATIVE_MAP, COR_IL_MAP, COR_PRF_MONITOR, DWORD, HANDLE, HRESULT, LPCBYTE,
    },
    AppDomainInfo, ArrayClassInfo, AssemblyInfo, ClassInfo, FunctionInfo, FunctionTokenAndMetadata, IlFunctionBody, MetadataImport, ModuleInfo,
};
