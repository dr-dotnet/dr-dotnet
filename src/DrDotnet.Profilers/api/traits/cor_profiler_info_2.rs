use crate::{
    ffi::{
        mdFieldDef, mdMethodDef, mdTypeDef, AppDomainID, ClassID, ContextID, FunctionEnter2, FunctionID, FunctionLeave2, FunctionTailcall2, ModuleID, ObjectID,
        StackSnapshotCallback, ThreadID, BYTE, COR_PRF_CODE_INFO, COR_PRF_EX_CLAUSE_INFO, COR_PRF_FRAME_INFO, COR_PRF_GC_GENERATION_RANGE,
        COR_PRF_SNAPSHOT_INFO, COR_PRF_STATIC_TYPE, HRESULT,
    },
...
pub trait CorProfilerInfo2: CorProfilerInfo {
    ...
    fn set_enter_leave_function_hooks_2(&self, func_enter: FunctionEnter2, func_leave: FunctionLeave2, func_tailcall: FunctionTailcall2)
        -> Result<(), HRESULT>;
    ...
    fn get_rva_static_address(&self, class_id: ClassID, field_token: mdFieldDef) -> Result<*const c_void, HRESULT>;
    fn get_app_domain_static_address(&self, class_id: ClassID, field_token: mdFieldDef, app_domain_id: AppDomainID) -> Result<*const c_void, HRESULT>;
    fn get_thread_static_address(&self, class_id: ClassID, field_token: mdFieldDef, thread_id: ThreadID) -> Result<*const c_void, HRESULT>;
    fn get_context_static_address(&self, class_id: ClassID, field_token: mdFieldDef, context_id: ContextID) -> Result<*const c_void, HRESULT>;
