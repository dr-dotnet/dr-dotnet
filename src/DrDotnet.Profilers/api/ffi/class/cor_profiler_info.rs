...
use crate::ffi::{
    int, mdFieldDef, mdMethodDef, mdToken, mdTypeDef, AppDomainID, AssemblyID, ClassID, ContextID, CorElementType, CorProfilerFunctionEnum,
    CorProfilerMethodEnum, CorProfilerModuleEnum, CorProfilerObjectEnum, CorProfilerThreadEnum, FunctionEnter, FunctionEnter2, FunctionEnter3,
    ...
    FunctionTailcall, FunctionTailcall2, FunctionTailcall3, FunctionTailcall3WithInfo, ICorProfilerInfo, ICorProfilerInfo10, ICorProfilerInfo2,
    ICorProfilerInfo3, ICorProfilerInfo4, ICorProfilerInfo5, ICorProfilerInfo6, ICorProfilerInfo7, ICorProfilerInfo8, ICorProfilerInfo9, IUnknown,
    MethodMalloc, ModuleID, ObjectID, ObjectReferenceCallback, ProcessID, ReJITID, StackSnapshotCallback, ThreadID, Unknown, BOOL, BYTE,
    COR_DEBUG_IL_TO_NATIVE_MAP, COR_FIELD_OFFSET, COR_IL_MAP, COR_PRF_CODE_INFO, COR_PRF_ELT_INFO, COR_PRF_EX_CLAUSE_INFO, COR_PRF_FRAME_INFO,
    COR_PRF_FUNCTION_ARGUMENT_INFO, COR_PRF_FUNCTION_ARGUMENT_RANGE, COR_PRF_GC_GENERATION_RANGE, COR_PRF_RUNTIME_TYPE, COR_PRF_STATIC_TYPE, DWORD, HANDLE,
    HRESULT, LPCBYTE, PCCOR_SIGNATURE, REFIID, SIZE_T, UINT_PTR, ULONG, ULONG32, USHORT, WCHAR,
};
use std::ffi::c_void;
#[repr(C)]
...
impl CorProfilerInfo {
    ...
    pub unsafe fn GetClassFromToken(&self, moduleId: ModuleID, typeDef: mdTypeDef, pClassId: *mut ClassID) -> HRESULT {
        (self.i_cor_profiler_info().GetClassFromToken)(self, moduleId, typeDef, pClassId)
    }
    pub unsafe fn GetCodeInfo(&self, functionId: FunctionID, pStart: *mut LPCBYTE, pcSize: *mut ULONG) -> HRESULT {
    ...
    pub unsafe fn GetFunctionFromToken(&self, moduleId: ModuleID, token: mdToken, pFunctionId: *mut FunctionID) -> HRESULT {
    ...
    pub unsafe fn IsArrayClass(&self, classId: ClassID, pBaseElemType: *mut CorElementType, pBaseClassId: *mut ClassID, pcRank: *mut ULONG) -> HRESULT {
        (self.i_cor_profiler_info().IsArrayClass)(self, classId, pBaseElemType, pBaseClassId, pcRank)
    }
    pub unsafe fn GetThreadInfo(&self, threadId: ThreadID, pdwWin32ThreadId: *mut DWORD) -> HRESULT {
    ...
    pub unsafe fn GetClassIDInfo(&self, classId: ClassID, pModuleId: *mut ModuleID, pTypeDefToken: *mut mdTypeDef) -> HRESULT {
        (self.i_cor_profiler_info().GetClassIDInfo)(self, classId, pModuleId, pTypeDefToken)
    }
    pub unsafe fn GetFunctionInfo(&self, functionId: FunctionID, pClassId: *mut ClassID, pModuleId: *mut ModuleID, pToken: *mut mdToken) -> HRESULT {
    ...
    pub unsafe fn SetEnterLeaveFunctionHooks(
        ...
        (self.i_cor_profiler_info().SetEnterLeaveFunctionHooks)(self, pFuncEnter, pFuncLeave, pFuncTailcall)
    }
    ...
    pub unsafe fn GetTokenAndMetaDataFromFunction(
        ...
        (self.i_cor_profiler_info().GetTokenAndMetaDataFromFunction)(self, functionId, riid, ppImport, pToken)
    }
    pub unsafe fn GetModuleInfo(
        ...
        (self.i_cor_profiler_info().GetModuleInfo)(self, moduleId, ppBaseLoadAddress, cchName, pcchName, szName, pAssemblyId)
    }
    ...
    pub unsafe fn GetILFunctionBody(&self, moduleId: ModuleID, methodId: mdMethodDef, ppMethodHeader: *mut LPCBYTE, pcbMethodSize: *mut ULONG) -> HRESULT {
        (self.i_cor_profiler_info().GetILFunctionBody)(self, moduleId, methodId, ppMethodHeader, pcbMethodSize)
    }
    pub unsafe fn GetILFunctionBodyAllocator(&self, moduleId: ModuleID, ppMalloc: *mut *mut MethodMalloc) -> HRESULT {
    ...
    pub unsafe fn SetILFunctionBody(
        ...
        (self.i_cor_profiler_info().SetILFunctionBody)(self, moduleId, methodid, pbNewILMethodHeader)
    }
    pub unsafe fn GetAppDomainInfo(
        ...
        (self.i_cor_profiler_info().GetAppDomainInfo)(self, appDomainId, cchName, pcchName, szName, pProcessId)
    }
    pub unsafe fn GetAssemblyInfo(
        ...
        (self.i_cor_profiler_info().GetAssemblyInfo)(self, assemblyId, cchName, pcchName, szName, pAppDomainId, pModuleId)
    }
    ...
    pub unsafe fn SetILInstrumentedCodeMap(&self, functionId: FunctionID, fStartJit: BOOL, cILMapEntries: ULONG, rgILMapEntries: *const COR_IL_MAP) -> HRESULT {
        (self.i_cor_profiler_info().SetILInstrumentedCodeMap)(self, functionId, fStartJit, cILMapEntries, rgILMapEntries)
    }
    ...
    pub unsafe fn GetThreadContext(&self, threadId: ThreadID, pContextId: *mut ContextID) -> HRESULT {
        (self.i_cor_profiler_info().GetThreadContext)(self, threadId, pContextId)
    }
    pub unsafe fn BeginInprocDebugging(&self, fThisThreadOnly: BOOL, pdwProfilerContext: *mut DWORD) -> HRESULT {
    ...
    pub unsafe fn GetILToNativeMapping(&self, functionId: FunctionID, cMap: ULONG32, pcMap: *mut ULONG32, map: *mut COR_DEBUG_IL_TO_NATIVE_MAP) -> HRESULT {
    ...
    pub unsafe fn DoStackSnapshot(
        ...
        (self.i_cor_profiler_info_2().DoStackSnapshot)(self, thread, callback, infoFlags, clientData, context, contextSize)
    }
    pub unsafe fn SetEnterLeaveFunctionHooks2(
        ...
        (self.i_cor_profiler_info_2().SetEnterLeaveFunctionHooks2)(self, pFuncEnter, pFuncLeave, pFuncTailcall)
    }
    pub unsafe fn GetFunctionInfo2(
        ...
        (self.i_cor_profiler_info_2().GetFunctionInfo2)(self, funcId, frameInfo, pClassId, pModuleId, pToken, cTypeArgs, pcTypeArgs, typeArgs)
    }
    pub unsafe fn GetStringLayout(&self, pBufferLengthOffset: *mut ULONG, pStringLengthOffset: *mut ULONG, pBufferOffset: *mut ULONG) -> HRESULT {
        (self.i_cor_profiler_info_2().GetStringLayout)(self, pBufferLengthOffset, pStringLengthOffset, pBufferOffset)
    }
    pub unsafe fn GetClassLayout(
        ...
        (self.i_cor_profiler_info_2().GetClassLayout)(self, classID, rFieldOffset, cFieldOffset, pcFieldOffset, pulClassSize)
    }
    pub unsafe fn GetClassIDInfo2(
        ...
        (self.i_cor_profiler_info_2().GetClassIDInfo2)(self, classId, pModuleId, pTypeDefToken, pParentClassId, cNumTypeArgs, pcNumTypeArgs, typeArgs)
    }
    pub unsafe fn GetCodeInfo2(&self, functionID: FunctionID, cCodeInfos: ULONG32, pcCodeInfos: *mut ULONG32, codeInfos: *mut COR_PRF_CODE_INFO) -> HRESULT {
        (self.i_cor_profiler_info_2().GetCodeInfo2)(self, functionID, cCodeInfos, pcCodeInfos, codeInfos)
    }
    pub unsafe fn GetClassFromTokenAndTypeArgs(
        ...
        (self.i_cor_profiler_info_2().GetClassFromTokenAndTypeArgs)(self, moduleID, typeDef, cTypeArgs, typeArgs, pClassID)
    }
    pub unsafe fn GetFunctionFromTokenAndTypeArgs(
        ...
        (self.i_cor_profiler_info_2().GetFunctionFromTokenAndTypeArgs)(self, moduleID, funcDef, classId, cTypeArgs, typeArgs, pFunctionID)
    }
    pub unsafe fn EnumModuleFrozenObjects(&self, moduleID: ModuleID, ppEnum: *mut *mut CorProfilerObjectEnum) -> HRESULT {
    ...
    pub unsafe fn GetArrayObjectInfo(
        ...
        (self.i_cor_profiler_info_2().GetArrayObjectInfo)(self, objectId, cDimensions, pDimensionSizes, pDimensionLowerBounds, ppData)
    }
    pub unsafe fn GetBoxClassLayout(&self, classId: ClassID, pBufferOffset: *mut ULONG32) -> HRESULT {
        (self.i_cor_profiler_info_2().GetBoxClassLayout)(self, classId, pBufferOffset)
    }
    pub unsafe fn GetThreadAppDomain(&self, threadId: ThreadID, pAppDomainId: *mut AppDomainID) -> HRESULT {
        (self.i_cor_profiler_info_2().GetThreadAppDomain)(self, threadId, pAppDomainId)
    }
    pub unsafe fn GetRVAStaticAddress(&self, classId: ClassID, fieldToken: mdFieldDef, ppAddress: *mut *mut c_void) -> HRESULT {
        (self.i_cor_profiler_info_2().GetRVAStaticAddress)(self, classId, fieldToken, ppAddress)
    }
    pub unsafe fn GetAppDomainStaticAddress(&self, classId: ClassID, fieldToken: mdFieldDef, appDomainId: AppDomainID, ppAddress: *mut *mut c_void) -> HRESULT {
        (self.i_cor_profiler_info_2().GetAppDomainStaticAddress)(self, classId, fieldToken, appDomainId, ppAddress)
    }
    pub unsafe fn GetThreadStaticAddress(&self, classId: ClassID, fieldToken: mdFieldDef, threadId: ThreadID, ppAddress: *mut *mut c_void) -> HRESULT {
        (self.i_cor_profiler_info_2().GetThreadStaticAddress)(self, classId, fieldToken, threadId, ppAddress)
    }
    pub unsafe fn GetContextStaticAddress(&self, classId: ClassID, fieldToken: mdFieldDef, contextId: ContextID, ppAddress: *mut *mut c_void) -> HRESULT {
        (self.i_cor_profiler_info_2().GetContextStaticAddress)(self, classId, fieldToken, contextId, ppAddress)
    }
    pub unsafe fn GetStaticFieldInfo(&self, classId: ClassID, fieldToken: mdFieldDef, pFieldInfo: *mut COR_PRF_STATIC_TYPE) -> HRESULT {
        (self.i_cor_profiler_info_2().GetStaticFieldInfo)(self, classId, fieldToken, pFieldInfo)
    }
    pub unsafe fn GetGenerationBounds(&self, cObjectRanges: ULONG, pcObjectRanges: *mut ULONG, ranges: *mut COR_PRF_GC_GENERATION_RANGE) -> HRESULT {
        (self.i_cor_profiler_info_2().GetGenerationBounds)(self, cObjectRanges, pcObjectRanges, ranges)
    }
    pub unsafe fn GetObjectGeneration(&self, objectId: ObjectID, range: *mut COR_PRF_GC_GENERATION_RANGE) -> HRESULT {
        (self.i_cor_profiler_info_2().GetObjectGeneration)(self, objectId, range)
    }
    pub unsafe fn GetNotifiedExceptionClauseInfo(&self, pinfo: *mut COR_PRF_EX_CLAUSE_INFO) -> HRESULT {
    ...
    pub unsafe fn SetFunctionIDMapper2(&self, pFunc: *const FunctionIDMapper2, clientData: *const c_void) -> HRESULT {
        (self.i_cor_profiler_info_3().SetFunctionIDMapper2)(self, pFunc, clientData)
    }
    pub unsafe fn GetStringLayout2(&self, pStringLengthOffset: *mut ULONG, pBufferOffset: *mut ULONG) -> HRESULT {
    ...
    pub unsafe fn SetEnterLeaveFunctionHooks3(
        ...
        (self.i_cor_profiler_info_3().SetEnterLeaveFunctionHooks3)(self, pFuncEnter3, pFuncLeave3, pFuncTailcall3)
    }
    pub unsafe fn SetEnterLeaveFunctionHooks3WithInfo(
        ...
        (self.i_cor_profiler_info_3().SetEnterLeaveFunctionHooks3WithInfo)(self, pFuncEnter3WithInfo, pFuncLeave3WithInfo, pFuncTailcall3WithInfo)
    }
    pub unsafe fn GetFunctionEnter3Info(
        ...
        (self.i_cor_profiler_info_3().GetFunctionEnter3Info)(self, functionId, eltInfo, pFrameInfo, pcbArgumentInfo, pArgumentInfo)
    }
    pub unsafe fn GetFunctionLeave3Info(
        ...
        (self.i_cor_profiler_info_3().GetFunctionLeave3Info)(self, functionId, eltInfo, pFrameInfo, pRetvalRange)
    }
    pub unsafe fn GetFunctionTailcall3Info(&self, functionId: FunctionID, eltInfo: COR_PRF_ELT_INFO, pFrameInfo: *mut COR_PRF_FRAME_INFO) -> HRESULT {
        (self.i_cor_profiler_info_3().GetFunctionTailcall3Info)(self, functionId, eltInfo, pFrameInfo)
    }
    ...
    pub unsafe fn GetThreadStaticAddress2(
        ...
        (self.i_cor_profiler_info_3().GetThreadStaticAddress2)(self, classId, fieldToken, appDomainId, threadId, ppAddress)
    }
    pub unsafe fn GetAppDomainsContainingModule(
        ...
        (self.i_cor_profiler_info_3().GetAppDomainsContainingModule)(self, moduleId, cAppDomainIds, pcAppDomainIds, appDomainIds)
    }
    pub unsafe fn GetModuleInfo2(
        ...
        (self.i_cor_profiler_info_3().GetModuleInfo2)(self, moduleId, ppBaseLoadAddress, cchName, pcchName, szName, pAssemblyId, pdwModuleFlags)
    }
    ...
    pub unsafe fn RequestReJIT(&self, cFunctions: ULONG, moduleIds: *const ModuleID, methodIds: *const mdMethodDef) -> HRESULT {
        (self.i_cor_profiler_info_4().RequestReJIT)(self, cFunctions, moduleIds, methodIds)
    }
    pub unsafe fn RequestRevert(&self, cFunctions: ULONG, moduleIds: *const ModuleID, methodIds: *const mdMethodDef, status: *mut HRESULT) -> HRESULT {
    ...
    pub unsafe fn GetCodeInfo3(
        ...
        (self.i_cor_profiler_info_4().GetCodeInfo3)(self, functionID, reJitId, cCodeInfos, pcCodeInfos, codeInfos)
    }
    pub unsafe fn GetFunctionFromIP2(&self, ip: LPCBYTE, pFunctionId: *mut FunctionID, pReJitId: *mut ReJITID) -> HRESULT {
        (self.i_cor_profiler_info_4().GetFunctionFromIP2)(self, ip, pFunctionId, pReJitId)
    }
    pub unsafe fn GetReJITIDs(&self, functionId: FunctionID, cReJitIds: ULONG, pcReJitIds: *mut ULONG, reJitIds: *mut ReJITID) -> HRESULT {
        (self.i_cor_profiler_info_4().GetReJITIDs)(self, functionId, cReJitIds, pcReJitIds, reJitIds)
    }
    pub unsafe fn GetILToNativeMapping2(
        ...
        (self.i_cor_profiler_info_4().GetILToNativeMapping2)(self, functionId, reJitId, cMap, pcMap, map)
    }
    ...
    pub unsafe fn GetEventMask2(&self, pdwEventsLow: *mut DWORD, pdwEventsHigh: *mut DWORD) -> HRESULT {
    ...
    pub unsafe fn EnumNgenModuleMethodsInliningThisMethod(
        ...
        (self.i_cor_profiler_info_6().EnumNgenModuleMethodsInliningThisMethod)(self, inlinersModuleId, inlineeModuleId, inlineeMethodId, incompleteData, ppEnum)
    }
    pub unsafe fn ApplyMetaData(&self, moduleId: ModuleID) -> HRESULT {
        (self.i_cor_profiler_info_7().ApplyMetaData)(self, moduleId)
    }
    pub unsafe fn GetInMemorySymbolsLength(&self, moduleId: ModuleID, pCountSymbolBytes: *mut DWORD) -> HRESULT {
    ...
    pub unsafe fn ReadInMemorySymbols(
        ...
        (self.i_cor_profiler_info_7().ReadInMemorySymbols)(self, moduleId, symbolsReadOffset, pSymbolBytes, countSymbolBytes, pCountSymbolBytesRead)
    }
    pub unsafe fn IsFunctionDynamic(&self, functionId: FunctionID, isDynamic: *mut BOOL) -> HRESULT {
        (self.i_cor_profiler_info_8().IsFunctionDynamic)(self, functionId, isDynamic)
    }
    pub unsafe fn GetFunctionFromIP3(&self, ip: LPCBYTE, functionId: *mut FunctionID, pReJitId: *mut ReJITID) -> HRESULT {
    ...
    pub unsafe fn GetDynamicFunctionInfo(
        ...
        (self.i_cor_profiler_info_8().GetDynamicFunctionInfo)(self, functionId, moduleId, ppvSig, pbSig, cchName, pcchName, wszName)
    }
    pub unsafe fn GetNativeCodeStartAddresses(
        ...
        (self.i_cor_profiler_info_9().GetNativeCodeStartAddresses)(self, functionID, reJitId, cCodeStartAddresses, pcCodeStartAddresses, codeStartAddresses)
    }
    pub unsafe fn GetILToNativeMapping3(
        ...
        (self.i_cor_profiler_info_9().GetILToNativeMapping3)(self, pNativeCodeStartAddress, cMap, pcMap, map)
    }
    pub unsafe fn GetCodeInfo4(
        ...
        (self.i_cor_profiler_info_9().GetCodeInfo4)(self, pNativeCodeStartAddress, cCodeInfos, pcCodeInfos, codeInfos)
    }
    pub unsafe fn EnumerateObjectReferences(&self, objectId: ObjectID, callback: ObjectReferenceCallback, clientData: *const c_void) -> HRESULT {
        (self.i_cor_profiler_info_10().EnumerateObjectReferences)(self, objectId, callback, clientData)
    }
    ...
    pub unsafe fn RequestReJITWithInliners(
        ...
        (self.i_cor_profiler_info_10().RequestReJITWithInliners)(self, dwRejitFlags, cFunctions, moduleIds, methodIds)
    }
