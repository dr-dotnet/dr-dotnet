...
impl Profiler for AsyncProfiler {
    ...
    fn profiler_info() -> ProfilerInfo {
        return ProfilerInfo {
            uuid: "805A308B-061C-47F3-9B30-A283B2056E79".to_owned(),
            name: "List async hotpaths".to_owned(),
...
#[derive(Default)]
pub struct AsyncHotpathStackSnapshotCallbackReceiver {
    method_ids: Vec<FunctionID>,
    hasher: DefaultHasher,
}

impl StackSnapshotCallbackReceiver for AsyncHotpathStackSnapshotCallbackReceiver {
...
impl AsyncProfiler {
    fn build_callstacks(
        ...
        for managed_thread_id in pinfo.enum_threads().unwrap() {
            let mut stack_snapshot_receiver = AsyncHotpathStackSnapshotCallbackReceiver::default();
    ...
    fn profile(session_info: SessionInfo, clr: ClrProfilerInfo) {
        ...
        let mut report = session_info.create_report("async_hotpaths.html".to_owned());
        report.write_line("<h2>Async Hotpaths</h2>".to_owned());
...
impl CorProfilerCallback for AsyncProfiler {}

impl CorProfilerCallback2 for AsyncProfiler {}

impl CorProfilerCallback3 for AsyncProfiler {
    ...
    fn profiler_attach_complete(&mut self) -> Result<(), ffi::HRESULT> {
        ...
        std::thread::spawn(move || AsyncProfiler::profile(session_info, clr));
...
impl CorProfilerCallback4 for AsyncProfiler {}
impl CorProfilerCallback5 for AsyncProfiler {}
impl CorProfilerCallback6 for AsyncProfiler {}
impl CorProfilerCallback7 for AsyncProfiler {}
impl CorProfilerCallback8 for AsyncProfiler {}
impl CorProfilerCallback9 for AsyncProfiler {}
