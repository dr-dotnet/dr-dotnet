...
pub trait StackSnapshotCallbackReceiver {
    ...
    unsafe extern "system" fn stack_snapshot_callback(method_id: FunctionID, ip: usize, frame_info: usize, context_size: u32, context: *const u8, client_data: *mut std::ffi::c_void) -> HRESULT {
        let temp_vec;
